...
import de.schildbach.pte.AbstractHafasProvider;
 ...
 */
public abstract class ExtendableAbstractHafasClientInterfaceProvider extends AbstractHafasProvider {
	...
	public ExtendableAbstractHafasClientInterfaceProvider(final NetworkId network, final HttpUrl apiBase,
	...
	protected ExtendableAbstractHafasClientInterfaceProvider setApiEndpoint(final String apiEndpoint) {
	...
	protected ExtendableAbstractHafasClientInterfaceProvider setApiVersion(final String apiVersion) {
	...
	protected ExtendableAbstractHafasClientInterfaceProvider setApiExt(final String apiExt) {
	...
	protected ExtendableAbstractHafasClientInterfaceProvider setApiAuthorization(final String apiAuthorization) {
	...
	protected ExtendableAbstractHafasClientInterfaceProvider setApiClient(final String apiClient) {
	...
	protected ExtendableAbstractHafasClientInterfaceProvider setRequestChecksumSalt(final byte[] requestChecksumSalt) {
	...
	protected ExtendableAbstractHafasClientInterfaceProvider setRequestMicMacSalt(final byte[] requestMicMacSalt) {
	...
	protected List<Line> parseProdList(final JSONArray prodList, final List<String> operators, final List<Style> styles)
			throws JSONException {
