...
constructor(private val settingsManager: SettingsManager, private val transportNetworks: TransportNetworks) {
    ...
    fun getTransportNetworkByNetworkId(networkId: NetworkId?): TransportNetwork? {
        return if (networkId == null) null else transportNetworks.getTransportNetwork(networkId)
    }
