...
class TransportNetworks(
    httpClient: HttpClient
) {
    val networks = arrayOf(
        Continent(
            Res.string.np_continent_europe, Res.drawable.continent_europe,
            listOf(
                Country(
                    Res.string.np_continent_europe, flag = "🇪🇺", sticky = true, networks = listOf(
                        TransportNetwork(
                            id = NetworkId.DB,
    ...
    private val NAVITIA = "87a37b95-913a-4cb4-ba52-eb0bc0b304ca"
    private val VAO = "{\"aid\":\"hf7mcf9bv3nv8g5f\",\"pw\":\"87a6f8ZbnBih32\",\"type\":\"USER\",\"user\":\"mobile\"}"
...
//internal fun getTransportNetworPositions(network: TransportNetwork): Triple<Int, Int, Int> {
