...
import de.libf.transportrng.ui.directions.composables.CompactTextField
import org.jetbrains.compose.resources.painterResource
import org.jetbrains.compose.resources.stringResource
import transportr_ng.composeapp.generated.resources.Res
import transportr_ng.composeapp.generated.resources.clear_location
import transportr_ng.composeapp.generated.resources.ic_action_content_remove
...
import transportr_ng.composeapp.generated.resources.stations_searching_position
                    ...
                    DropdownMenuItem(
                        ...
                        text = {
                            if (sug.wrapType == WrapLocation.WrapType.GPS)
                                Text(
                                    text = stringResource(Res.string.location_gps),
...
fun LocationGpsInput(
    ...
    var isFocused by remember { mutableStateOf(false) }
    var showSuggestions by remember { mutableStateOf(true) }
    var text by remember { mutableStateOf(location?._getName() ?: "") }

    LaunchedEffect(location) {
        location?._getName()?.takeIf { it.isNotBlank() }?.let { text = it }
    }
        ...
        OutlinedTextField(
            ...
            leadingIcon = {
                if(location != null) {
                    ...
                    Icon(
                        painterResource(Res.drawable.ic_gps),
                        contentDescription = null,
        ...
        { // Placeholder
            Text(
                text = if(isGpsLoading)
                            stringResource(Res.string.stations_searching_position)
                        else
                            placeholder
            )
        },
...
)
{
    LocationInputField(
        ...
        CompactTextField(
            ...
            label = { Text(if(isGpsLoading) stringResource(Res.string.stations_searching_position) else label) },
...
fun CompactLocationInput(
    ...
    CompactTextField(
        ...
        label = { Text(label) },
        placeholder = {
            Text(if(isGpsLoading) stringResource(Res.string.location_gps) else placeholder)
        },
        singleLine = true,
        padding = padding,
        textStyle = MaterialTheme.typography.bodyLarge
