...
import transportr_ng.composeapp.generated.resources.action_set_locations
import transportr_ng.composeapp.generated.resources.action_swap_locations
import transportr_ng.composeapp.generated.resources.action_trip_delete
...
import transportr_ng.composeapp.generated.resources.ic_delete
import transportr_ng.composeapp.generated.resources.ic_menu_swap_location
import transportr_ng.composeapp.generated.resources.ic_mode_edit
...
fun SavedSearchItem(
    ...
    ElevatedCard(
        ...
        Row(
            ...
            Icon(
                painter = painterResource(if(itm.favorite) Res.drawable.ic_action_star else Res.drawable.ic_time),
...
fun ColumnScope.SavedSearchItemPopupMenu(
    ...
    // Edit search
    PopupMenuItem(
        text = Res.string.action_set_locations,
        icon = Res.drawable.ic_mode_edit
    ) {
    ...
    PopupMenuItem(
        text = Res.string.action_fav_trip,
        icon = Res.drawable.ic_action_star
    ) {
        actions.onSetTripFavoriteRequested(it, !it.favorite)
    }
    ...
    // Delete
    PopupMenuItem(
        text = Res.string.action_trip_delete,
